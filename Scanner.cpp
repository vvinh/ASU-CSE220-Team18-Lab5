...
void Scanner::getNumber(char *str, char *token_ptr, Identifier *tok)
{
    ...
    *token_ptr = '\0';
    ...
    if (int_type)
    {
    	IntegerLiteral* aIntegerLiteralPtr = new IntegerLiteral((int)atoi(str));  //`
        tok->setType(aIntegerLiteralPtr);
        tok->setLiteral((int)atoi(str));
    }
    else
    {
    	RealLiteral* aRealLiteralPtr = new RealLiteral((float)atof(str));  //`
        tok->setType(aRealLiteralPtr);
...
void Scanner::getString(char *str, char *token_ptr, Identifier *tok)
{
    ...
    *token_ptr = '\0';
    ...
    StringLiteral* aStringLiteralPtr = new StringLiteral(test);  //`
